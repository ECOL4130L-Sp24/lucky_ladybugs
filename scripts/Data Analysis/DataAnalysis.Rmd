...
df1 <- read.csv(here("data", "processed", "algal_biomass", "alg_biomass_means.csv")) 
df2 <- read.csv(here("data", "processed", "fish","final_fish_count_means.csv"))
df3 <- read.csv(here("data", "processed", "nutrient_data_WQ","waterqual_means.csv"))
df4 <- read.csv(here("data", "processed", "nutrient_data_WQ","SW_Nitrate_means.csv"))
